...
<style>
    ...
    /* 精確黑化文字內容，不干擾 Streamlit 原生 Icon */
...
industry_map = {
    ...
    "AI伺服器/代工": {"鴻海 (2317)": "2317.TW", "廣達 (2382)": "2382.TW", "緯穎 (6669)": "6669.TW", "緯創 (3231)": "3231.TW", "技嘉 (2376)": "2376.TW"},
...
<div style="background:#FFFFFF; padding:20px; border:2px solid #B18D4D; border-radius:12px; color:#000;">
    ...
    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:25px; font-size:14px; line-height:1.7;">
        ...
        <div>
            <b>【利多題材 / 最新動態】</b><br>{an['利多題材']}<br><br>
            <b>【法人動向分析】</b><br>{an['法人動向']}
        </div>
    </div>
    <div style="margin-top:15px; font-size:13.5px; border-top:1px dashed #D6D2C4; padding-top:10px;">
        <span><b>未來 3 個月機率分布：</b>看多 <span style="color:#9F353A; font-weight:600;">{an['看多機率']}%</span> | {an['機率分布']}</span>
    </div>
</div>
"""
